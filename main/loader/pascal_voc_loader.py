...
class pascalVOCLoader(data.Dataset):
    def __init__(self, root, split="train_aug", is_transform=False, img_size=512):
        ...
        # Reading 4 pascal VOC dataset lists
        ...
        # self.files['trainval_aug'] = self.sbd_train_list + self.sbd_val_list + self.files['trainval']
...
if __name__ == '__main__':
    dl = pascalVOCLoader(root=get_data_path('pascal'))